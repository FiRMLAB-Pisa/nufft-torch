...
Welcome to `deepmr` contributor's guide.
...
If you experience bugs or general issues with `deepmr`, please have a look
...
You can help improve `deepmr` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`deepmr` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `deepmr`'s files. While this mechanism can
...
```
conda create -n deepmr python=3 six virtualenv pytest pytest-cov
conda activate deepmr
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/deepmr.git
   cd deepmr
   ```
...
5. Install [pre-commit]:
   ...
   `deepmr` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/deepmr
[issue tracker]: https://github.com/<USERNAME>/deepmr/issues
