...
def nufft(image: Tensor, interpolator: Dict) -> Tensor:
    ...
    dispatcher = _subroutines.DeviceDispatch(
...
def toeplitz_convolution(image: Tensor, toeplitz_dict: Dict) -> Tensor:
    ...
    # FFT
    kdata_in = _subroutines.FFT(image)(
        image, axes=range(-ndim, 0), norm=None, center=False
    )
    ...
    # IFFT
    image = _subroutines.IFFT(kdata_out)(
        kdata_out, axes=range(-ndim, 0), norm=None, center=False
    )
